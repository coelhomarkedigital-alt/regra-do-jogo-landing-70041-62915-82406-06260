...
export const Doubts = () => {
  const doubts = [
    ...
    },
    {
      ...
      stat: "Acesso às gravações durante a assinatura.",
    },
    {
      icon: Shield,
      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="text-center space-y-4 animate-fade-in">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-paper-foreground">Ainda está em dúvida?</h2>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="flex items-start gap-2 pt-2">
                        ...
                        <p className="text-sm font-semibold text-paper-foreground">{doubt.stat}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
