      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-6xl mx-auto space-y-10">
                    ...
                    <Card className="bg-card shadow-card hover:shadow-hover transition-all duration-300 hover:-translate-y-2 border-border/50 group h-full">
                      <CardContent className="pt-8 pb-6 px-6 space-y-4">
                        <div className="flex justify-center mb-4">
                          <div className="relative group-hover:scale-105 transition-transform duration-300 bg-white p-2 rounded-lg overflow-hidden" style={{
                        boxShadow: '0 0 25px rgba(251, 191, 36, 0.5), 0 0 50px rgba(245, 192, 69, 0.3)'
                      }}>
                            <img src={book.cover} alt={`Capa do livro ${book.title}`} className="h-52 w-auto object-cover scale-110" />
                          </div>
                        </div>
          ...
          <div className="text-center pt-2">
            <p className="text-muted-foreground">8 obras cuidadosamente selecionadas para os encontros do Clube do Livro em 2026.</p>
          </div>
        </div>
      </div>
    </section>;
